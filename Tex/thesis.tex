...
\input{Utills/01_packages}
\addbibresource{Utills/thesis.bib}

% Додаткові визначення та перевизначення команд вносіть у цей файл
\input{Utills/02_redefinitions}

% % Бюрократичні відомості про автора роботи
\input{Utills/03_data}
...
\input{Utills/a00_title}

% Створюємо завдання
\input{Utills/a01_specification}

% Створюємо анотації
% \setcounter{page}{4}    %!!! -- продумати, як автоматизувати номер сторінки
